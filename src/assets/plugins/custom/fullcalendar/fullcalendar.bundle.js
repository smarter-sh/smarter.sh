...
var FullCalendar = (function (exports) {
  ...
  function b$1(n, l, u) {
    '-' === l[0]
      ...
      : (n[l] = null == u ? '' : 'number' != typeof u || a$1.test(l) ? u : u + 'px')
  }
    ...
    for (u.__k = [], h = 0; h < l.length; h++)
      if (
        ...
        ;(M(n, d, (y = y || c$1), t, r, o, f, e, a),
          ...
          (v = d.ref) &&
            y.ref != v &&
            (g || (g = []), y.ref && g.push(y.ref, null, d), g.push(v, d.__c || k, d)),
          null != k
            ? (null == b && (b = k),
  ...
  function I$1(n, l, u) {
    for (var i, t = n.__k, r = 0; t && r < t.length; r++)
      (i = t[r]) &&
        ((i.__ = n),
        (l = 'function' == typeof i.type ? I$1(i, l, u) : z$1(u, i, i, t, i.__e, l)))
    return l
  }
  function j$2(n, l) {
    return (
    ...
    try {
      n: if ('function' == typeof $) {
        if (
          ...
          i.__c
            ...
            : ('prototype' in $ && $.prototype.render
                ? (u.__c = a = new $(b, m))
                : ((u.__c = a = new x$1(b, m)), (a.constructor = $), (a.render = B$1)),
              g && g.sub(a),
              (a.props = b),
              a.state || (a.state = {}),
              (a.context = m),
          ...
          if (
            ...
            for (
              u.__v !== i.__v && ((a.props = b), (a.state = a.__s), (a.__d = !1)),
                u.__e = i.__e,
                u.__k = i.__k,
        ...
        ;((a.state = a.__s),
          ...
          (T = null != s && s.type === _ && null == s.key ? s.props.children : s),
  ...
  function U(n, t, e) {
    return (
      n &&
        ...
        n.__c &&
          n.__c.__P === t &&
          (n.__e && e.insertBefore(n.__e, n.__d), (n.__c.__e = !0), (n.__c.__P = e))),
      n
    )
  }
  function D() {
  ...
  function getEventTargetViaRoot(ev) {
    var _a, _b
    return (_b =
      (_a = ev.composedPath) === null || _a === void 0 ? void 0 : _a.call(ev)[0]) !==
      null && _b !== void 0
      ? _b
      : ev.target
  }
  ...
  function combineTwoEventUis(item0, item1) {
    return {
      ...
      durationEditable:
        item1.durationEditable != null ? item1.durationEditable : item0.durationEditable,
      ...
      if (slicedRange) {
        if (ui.display === 'inverse-background') {
          ...
          ;(ui.display === 'background' ? bgRanges : fgRanges).push({
            ...
            isEnd:
              normalRange.end && normalRange.end.valueOf() === slicedRange.end.valueOf(),
          })
        }
      }
    }
  ...
  function parse(str) {
    ...
    if (m) {
      ...
      if (isValidDate(marker)) {
        ...
        if (m[13]) {
          timeZoneOffset =
            (m[15] === '-' ? -1 : 1) * (Number(m[16] || 0) * 60 + Number(m[18] || 0))
        }
        return {
          marker: marker,
  ...
  var DateEnv = /** @class */ (function () {
    ...
    DateEnv.prototype.toDate = function (m, forcedTzo) {
      ...
      return new Date(
        m.valueOf() - this.namedTimeZoneImpl.offsetForArray(dateToUtcArray(m)) * 1000 * 60
      )
    }
    return DateEnv
  })()
  ...
  function buildDateEnv$1(settings) {
    ...
    return new DateEnv(
      __assign(
        __assign(
          { timeZone: BASE_OPTION_DEFAULTS.timeZone, calendarSystem: 'gregory' },
          settings
        ),
        { locale: locale }
      )
    ...
    sourceDef.fetch(
      ...
      function (res) {
        ...
        if (options.eventSourceSuccess) {
          rawEvents =
            options.eventSourceSuccess.call(calendarApi, rawEvents, res.xhr) || rawEvents
        }
        if (eventSource.success) {
          rawEvents =
            eventSource.success.call(calendarApi, rawEvents, res.xhr) || rawEvents
        }
        context.dispatch({
          type: 'RECEIVE_EVENTS',
  ...
  function handleDateProfile(dateProfile, context) {
    context.emitter.trigger(
      'datesSet',
      __assign(
        __assign({}, buildRangeApiWithTimeZone(dateProfile.activeRange, context.dateEnv)),
        { view: context.viewApi }
      )
    )
  }
      ...
      eventUiSingleBase: createEventUi(
        {
          ...
          overlap:
            typeof options.eventOverlap === 'boolean' ? options.eventOverlap : undefined,
        ...
        if (buttonName === 'title') {
          ...
          children.push(
            createElement(
              ...
              buttonText ||
                (buttonIcon ? createElement('span', { className: buttonIcon }) : '')
            )
          )
        }
      }
  ...
  var CalendarContent = /** @class */ (function (_super) {
    ...
    CalendarContent.prototype.buildAppendContent = function () {
      var props = this.props
      var children = props.pluginHooks.viewContainerAppends.map(
  ...
  var TableDateCell = /** @class */ (function (_super) {
    ...
    TableDateCell.prototype.render = function () {
      ...
      var hookProps = __assign(
        __assign(
          __assign({ date: dateEnv.toDate(date), view: viewApi }, props.extraHookProps),
          { text: text }
        ),
        dayMeta
      )
  ...
  var Slicer = /** @class */ (function () {
    ...
    Slicer.prototype.sliceNowDate = function (
      ...
      return this._sliceDateSpan.apply(
        this,
        __spreadArray(
          [{ range: { start: date, end: addMs(date, 1) }, allDay: false }, {}, context],
          extraArgs
        )
      )
    }
  ...
  function isInteractionPropsValid(state, context, dateSpanMeta, filterConfig) {
    ...
    for (var subjectInstanceId in subjectInstances) {
      ...
      for (var _i = 0, _a = subjectConfig.allows; _i < _a.length; _i++) {
        ...
        if (
          !subjectAllow(buildDateSpanApiWithContext(subjectDateSpan, context), eventApi)
        ) {
          return false
        }
      }
    ...
    SimpleScrollGrid.prototype.renderChunkTd = function (
      ...
      return createElement(
        ...
        createElement(
          ...
          {
            className:
              'fc-scroller-harness' + (isLiquid ? ' fc-scroller-harness-liquid' : ''),
          },
          createElement(
            Scroller,
            {
      ...
      _this.handleDragEnd = function (ev) {
        ...
        if (!pointer.wasTouchScroll) {
          ...
          if (initialHit && finalHit && isHitsEqual(initialHit, finalHit)) {
            var context = component.context
            var arg = __assign(
              __assign({}, buildDatePointApiWithContext(initialHit.dateSpan, context)),
              {
          ...
          if (validMutation) {
            ...
            if (receivingContext_1 === initialContext_1) {
              ...
              for (
                var _i = 0,
                  _b =
                    initialContext_1.getCurrentData().pluginHooks.eventDropTransformers;
                _i < _b.length;
                _i++
              ) {
              ...
              receivingContext_1.emitter.trigger(
                ...
                __assign(
                  __assign(
                    {},
                    buildDatePointApiWithContext(finalHit.dateSpan, receivingContext_1)
                  ),
                  {
                    draggedEl: ev.subjectEl,
                    jsEvent: ev.origEvent,
      ...
      _this.handlePointerDown = function (ev) {
        ...
        _this.dragging.setIgnoreMove(
          !_this.component.isValidSegDownEl(ev.origEvent.target) ||
            (ev.isTouch &&
              _this.component.props.eventSelection !== eventRange.instance.instanceId)
        )
      }
      _this.handleDragStart = function (ev) {
        var context = _this.component.context
      ...
      if (allDayContent) {
        ...
        sections.push({
          ...
          outerContent: createElement(
            ...
            createElement('td', {
              className:
                'fc-timegrid-divider ' + context.theme.getClass('tableCellShaded'),
            })
          ),
        })
      }
    ...
    TimeCol.prototype.renderPositionedFgSegs = function (
      ...
      return createElement(
        ...
        segPlacements.map(function (segPlacement) {
          ...
          var hStyle =
            !isMirror && rect ? _this.computeSegHStyle(rect) : { left: 0, right: 0 }
    ...
    return [
      ...
      },
      {
        ...
        moreLinkHint: function (e) {
          return (
            'Zeige ' + (1 === e ? 'ein weiteres Ereignis' : e + ' weitere Ereignisse')
          )
        },
        closeHint: 'Schließen',
        timeHint: 'Uhrzeit',
      ...
      },
      {
        ...
        viewHint: function (e) {
          return (
            'Vista ' + ('Semana' === e ? 'de la' : 'del') + ' ' + e.toLocaleLowerCase()
          )
        },
        weekText: 'Sm',
        weekTextLong: 'Semana',
