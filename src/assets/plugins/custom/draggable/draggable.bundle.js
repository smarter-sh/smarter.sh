;(function (global, factory) {
  ...
  class AbstractEvent {
    ...
    clone(data) {
      return new this.constructor({ ...this.data, ...data })
    }
  }
  ...
  const defaultDelay = { mouse: 0, drag: 0, touch: 100 }
  class Sensor {
  ...
  function AutoBind(originalMethod, { name, addInitializer }) {
  ...
  class MouseSensor extends Sensor {
    ...
    [onMouseDown$2](event) {
      ...
      Object.assign(this, { pageX: pageX, pageY: pageY })
      ...
      this.mouseDownTimeout = window.setTimeout(() => {
        this[onDistanceChange$1]({ pageX: this.pageX, pageY: this.pageY })
      }, delay.mouse)
    }
    [startDrag$1]() {
  ...
  function createAddInitializerMethod(e, t) {
    return function (r) {
      ;(assertNotFinished(t, 'addInitializer'),
  ...
  function memberDec(e, t, r, a, n, i, s, o, c, l, u) {
    ...
    var d,
      p,
      h = { kind: f, name: o ? '#' + r : r, static: s, private: o, metadata: u },
      v = { v: !1 }
    if (
      (0 !== i && (h.addInitializer = createAddInitializerMethod(n, v)),
      o || (0 !== i && 2 !== i))
    ) {
      if (2 === i)
        d = function (e) {
    ...
    h.access =
      d && p ? { get: d, set: p, has: m } : d ? { get: d, has: m } : { set: p, has: m }
    try {
      return e.call(t, c, h)
    } finally {
      v.v = !0
  ...
  function applyMemberDec(e, t, r, a, n, i, s, o, c, l, u) {
    ...
    ;(a || Array.isArray(m) || (m = [m]),
      o
        ? (f =
            0 === i || 1 === i
              ? { get: curryThis1(r[3]), set: curryThis2(r[4]) }
              : 3 === i
                ? { get: r[3] }
                : 4 === i
                  ? { set: r[3] }
                  : { value: r[3] })
        : 0 !== i && (f = Object.getOwnPropertyDescriptor(t, n)),
      1 === i
        ? (p = { get: f.get, set: f.set })
        : 2 === i
          ? (p = f.value)
          : 3 === i
            ? (p = f.get)
    ...
    for (var g = a ? 2 : 1, b = m.length - 1; b >= 0; b -= g) {
      var I
      if (
        void 0 !== (h = memberDec(m[b], a ? m[b - 1] : void 0, n, f, c, i, s, o, p, l, u))
      )
        (assertValidReturnValue(i, h),
          0 === i
            ? (I = h)
            : 1 === i
              ? ((I = h.init),
              ...
              : (p = h),
          void 0 !== I &&
            (void 0 === d ? (d = I) : 'function' == typeof d ? (d = [d, I]) : d.push(I)))
    }
    if (0 === i || 1 === i) {
      if (void 0 === d)
        d = function (e, t) {
  ...
  function applyClassDecs(e, t, r, a) {
    if (t.length) {
      for (
        var n = [], i = e, s = e.name, o = r ? 2 : 1, c = t.length - 1;
        c >= 0;
        c -= o
      ) {
        var l = { v: !1 }
  ...
  class ResizeMirror extends AbstractPlugin {
    ...
    resize(dragEvent) {
      requestAnimationFrame(() => {
        ...
        const overElement =
          over || this.draggable.getDraggableElementsForContainer(overContainer)[0]
        if (!overElement) {
          return
        }
        requestNextAnimationFrame(() => {
          ...
          if (
            this.mirror == null ||
            (this.lastHeight === overRect.height && this.lastWidth === overRect.width)
          ) {
            return
          }
  ...
  ;[_initProto$1] = _applyDecs2305(
    _class$1,
    [
      [AutoBind, 2, 'onMirrorCreated'],
      [AutoBind, 2, 'onMirrorDestroy'],
      [AutoBind, 2, 'onDragOver'],
    ],
    [],
    0,
    void 0,
  ...
  class SwapAnimation extends AbstractPlugin {
    constructor(draggable) {
      ...
      this.options = { ...defaultOptions$7, ...this.getOptions() }
  ...
  ;[_initProto] = _applyDecs2305(
    _class,
    [[AutoBind, 2, 'onSortableSorted']],
    [],
    0,
    void 0,
    AbstractPlugin
  ...
  const defaultOptions$6 = { duration: 150, easingFunction: 'ease-in-out' }
  class SortAnimation extends AbstractPlugin {
    constructor(draggable) {
      super(draggable)
      this.options = { ...defaultOptions$6, ...this.getOptions() }
      this.lastAnimationFrame = null
      this.lastElements = []
    ...
    [onSortableSort]({ dragEvent }) {
      ...
      this.lastElements = Array.from(elements).map((el) => {
        return { domEl: el, offsetTop: el.offsetTop, offsetLeft: el.offsetLeft }
      })
    }
  ...
  const ROLE = 'role'
  const defaultOptions$5 = { expire: 7e3 }
  class Announcement extends AbstractPlugin {
    constructor(draggable) {
      super(draggable)
      this.options = { ...defaultOptions$5, ...this.getOptions() }
  ...
  class Focusable extends AbstractPlugin {
    constructor(draggable) {
      super(draggable)
      this.options = { ...defaultOptions$4, ...this.getOptions() }
  ...
  class Mirror extends AbstractPlugin {
    constructor(draggable) {
      super(draggable)
      this.options = { ...defaultOptions$3, ...this.getOptions() }
    ...
    [onDragStart$5](dragEvent) {
      ...
      this.lastMirrorMovedClient = { x: sensorEvent.clientX, y: sensorEvent.clientY }
    ...
    [onMirrorMove](mirrorEvent) {
      ...
      const setState = ({ lastMovedX, lastMovedY, ...args }) => {
        ...
        return { lastMovedX: lastMovedX, lastMovedY: lastMovedY, ...args }
      }
  ...
  function computeMirrorDimensions({ source, ...args }) {
    return withPromise((resolve) => {
      ...
      resolve({ source: source, sourceRect: sourceRect, ...args })
    })
  }
  ...
  function resetMirror({ mirror, source, options, ...args }) {
    return withPromise((resolve) => {
      ...
      resolve({ mirror: mirror, source: source, options: options, ...args })
    })
  }
  function addMirrorClasses({ mirror, mirrorClasses, ...args }) {
    return withPromise((resolve) => {
      mirror.classList.add(...mirrorClasses)
      resolve({ mirror: mirror, mirrorClasses: mirrorClasses, ...args })
    })
  }
  ...
  const defaultOptions$2 = { speed: 6, sensitivity: 50, scrollableElements: [] }
  class Scrollable extends AbstractPlugin {
    ...
    getScrollableElement(target) {
      if (this.hasDefinedScrollableElements()) {
        return (
          closest(target, this.options.scrollableElements) || document.documentElement
        )
      } else {
  ...
  const defaultAnnouncements$3 = {
    'drag:start': (event) =>
      `Picked up ${event.source.textContent.trim() || event.source.id || 'draggable element'}`,
    'drag:stop': (event) =>
  ...
  class Draggable {
    constructor(containers = [document.body], options = {}) {
      ...
      this.options = {
        ...defaultOptions$1,
        ...options,
        classes: { ...defaultClasses$1, ...(options.classes || {}) },
        announcements: { ...defaultAnnouncements$3, ...(options.announcements || {}) },
        exclude: {
      ...
      const draggableInitializedEvent = new DraggableInitializedEvent({ draggable: this })
    ...
    destroy() {
      ...
      const draggableDestroyEvent = new DraggableDestroyEvent({ draggable: this })
    ...
    [onDragStart$3](event) {
      ...
      requestAnimationFrame(() => {
        ...
        this[onDragMove$1]({ ...event, detail: newSensorEvent })
      })
    }
    [onDragMove$1](event) {
      if (!this.dragging) {
    ...
    [onDragPressure](event) {
      ...
      const sensorEvent = getSensorEvent(event)
      const source =
        this.source || closest(sensorEvent.originalEvent.target, this.options.draggable)
  ...
  Draggable.Sensors = { MouseSensor: MouseSensor, TouchSensor: TouchSensor }
  ...
  const defaultOptions = { dropzone: '.draggable-droppable' }
  class Droppable extends Draggable {
    constructor(containers = [], options = {}) {
      super(containers, {
        ...
        announcements: { ...defaultAnnouncements$2, ...(options.announcements || {}) },
      })
      this.dropzones = null
    ...
    [onDragStart$2](event) {
      ...
      for (const dropzoneElement of this.dropzones) {
        if (
          dropzoneElement.classList.contains(this.getClassNameFor('droppable:occupied'))
        ) {
          continue
        }
  ...
  function onSwappableSwappedDefaultAnnouncement({ dragEvent, swappedElement }) {
    const sourceText =
      dragEvent.source.textContent.trim() || dragEvent.source.id || 'swappable element'
    const overText =
      swappedElement.textContent.trim() || swappedElement.id || 'swappable element'
  ...
  class Swappable extends Draggable {
    constructor(containers = [], options = {}) {
      super(containers, {
        ...options,
        announcements: { ...defaultAnnouncements$1, ...(options.announcements || {}) },
      })
      this.lastOver = null
    ...
    [onDragStart$1](event) {
      const swappableStartEvent = new SwappableStartEvent({ dragEvent: event })
    ...
    [onDragStop$1](event) {
      const swappableStopEvent = new SwappableStopEvent({ dragEvent: event })
  ...
  function onSortableSortedDefaultAnnouncement({ dragEvent }) {
    const sourceText =
      dragEvent.source.textContent.trim() || dragEvent.source.id || 'sortable element'
    if (dragEvent.over) {
      const overText =
        dragEvent.over.textContent.trim() || dragEvent.over.id || 'sortable element'
      const isFollowing =
  ...
  const defaultAnnouncements = { 'sortable:sorted': onSortableSortedDefaultAnnouncement }
