            ...
            ;(arguments[0] &&
                    ...
                    (e.drake = e
                          ...
                          ;(void 0 !== i.dragTo &&
                            e.options.boards.map(function (t) {
                              ;-1 === i.dragTo.indexOf(t.id) &&
                                ...
                                e.findBoard(t.id).classList.add('disabled-board')
                            }),
                      ...
                      .on('drop', function (t, n, o, i) {
                        ...
                        ;(void 0 !== r.dragTo &&
                          ...
                          e.drake.cancel(!0),
                        null !== t) &&
                          (!1 === e.options.dropEl(t, n, o, i) && e.drake.cancel(!0),
                          t.classList.remove('is-moving'),
                          'function' == typeof t.dropfn && t.dropfn(t, n, o, i))
                      }))))
              }),
              ...
              (this.addBoards = function (t, n) {
                ...
                for (var f in t) {
                  ...
                  if ('' !== p.class && void 0 !== p.class) var h = p.class.split(',')
                  else h = []
              ...
              (this.getBoardElements = function (t) {
                return e.element.querySelector('[data-id="' + t + '"] .kanban-drag')
                  .childNodes
              }),
            ...
            t.exports = function (e, t) {
              ...
              function F(e) {
                ...
                ;((t = e.item),
                  ...
                  ('boolean' == typeof A.copy ? A.copy : A.copy(t, n)) &&
                    ((L = e.item.cloneNode(!0)), _.emit('cloned', L, e.item, 'copy')),
                  (w = e.source),
                  (E = e.item),
                  (S = x = b(e.item)),
                  (_.dragging = !0),
              ...
              function W() {
                if (_.dragging) {
                  var e = L || E,
                    t = h(e)
                  ;(t && t.removeChild(e), _.emit(L ? 'cancel' : 'remove', e, t, w), V())
                }
              }
              function G(e) {
                if (_.dragging) {
                  var t = arguments.length > 0 ? e : A.revertOnSpill,
                    ...
                    o = h(n),
                    i = $(o)
                  ;(!1 === i && t && (L ? o && o.removeChild(L) : w.insertBefore(n, S)),
                    i || t ? _.emit('cancel', n, w, w) : _.emit('drop', n, o, w, x),
                    V())
                }
              }
              function V() {
              ...
              function $(e, t) {
                var o
                return ((o = void 0 !== t ? t : n ? x : b(L || E)), e === w && o === S)
              }
              function J(e, t, n) {
              ...
              function Q(e) {
                if (n) {
                  ...
                  if (d !== w || !L || A.copySortSource) {
                    ...
                    ;((null === f && s) || (f !== a && f !== b(a))) &&
                      ((x = f), d.insertBefore(a, f), _.emit('shadow', a, d, w))
              ...
              function ee(e, t, n, o) {
                ...
                return t !== e
                  ? ((i = t.getBoundingClientRect()),
                    a(r ? n > i.left + m(i) / 2 : o > i.top + v(i) / 2))
                  : (function () {
                      var t,
                        i,
                        a,
    ...
    10: [
      function (e, t, n) {
        ...
        var s,
          ...
          f = -1
        function p() {
          u && s && ((u = !1), s.length ? (l = s.concat(l)) : (f = -1), l.length && m())
        }
        function m() {
          if (!u) {
            var e = d(p)
        ...
        ;((r.nextTick = function (e) {
          ...
          ;(l.push(new v(e, t)), 1 !== l.length || u || d(m))
        }),
                ...
                'function' == typeof t
                  ...
                  : function (e) {
                      ...
                      return (
                        ...
                        i(function () {
                          c[t] &&
                            (o ? e.apply(null, o) : e.call(null), n.clearImmediate(t))
                        }),
                        t
                      )
                    }),
