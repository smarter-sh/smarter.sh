...
export const sameAs = [
  ...
  'https://horrors.smarter.sh/',
  'https://clients.smarter.sh/',
  'https://photography.smarter.sh/',
...
export const imagesLawrenceMcDaniel = [
  brandLogo,
  imageObject('https://cdn.smarter.sh', 512, 512),
  imageObject('https://cdn.smarter.sh/social-1200x675.jpg', 1200, 675),
  imageObject('https://cdn.smarter.sh/lawrencemcdaniel-headshot-square.jpeg', 1849, 1848),
  imageObject(
    'https://cdn.smarter.sh/wp-content/uploads/2020/06/05201857/Lawrence6.jpg',
    1600,
    1084
  ),
  imageObject(
    'https://cdn.smarter.sh/wp-content/uploads/2020/06/05201305/Lawrence21.jpg',
    1600,
    1067
  ),
  imageObject(
    'https://cdn.smarter.sh/wp-content/uploads/2014/09/22195642/Lawrence19.jpg',
    338,
    500
  ),
  imageObject(
    'https://cdn.smarter.sh/wp-content/uploads/2020/06/05220017/lawrence-mcdaniel-portrait.jpg',
    387,
    600
  ),
  imageObject(
    'https://cdn.smarter.sh/wp-content/uploads/2014/09/22195700/Lawrence-McDaniel-freelancer.jpg',
    750,
    706
  ),
  imageObject(
    'https://cdn.smarter.sh/wp-content/uploads/2016/11/22195702/lawrence-banner-bw.jpg',
    400,
    475
  ),
  imageObject(
    'https://cdn.smarter.sh/wp-content/uploads/2016/11/22195703/lawrence-headshot-bw.jpg',
    400,
    600
  ),
  imageObject(
    'https://cdn.smarter.sh/wp-content/uploads/2016/09/22195718/lawrence-headshot.jpg',
    500,
    500
  ),
  imageObject(
    'https://cdn.smarter.sh/wp-content/uploads/2017/09/22195635/smarter.sh-linkedin.png',
    1200,
    627
  ),
]
